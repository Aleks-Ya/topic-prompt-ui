...
public class TestingData {
    ...
    public static class I1 {
        ...
        public static final Interaction INTERACTION = new Interaction(new InteractionId(1L), InteractionType.QUESTION,
                ...
                GRAMMAR, new Answer(GRAMMAR, "QC prompt 1", "Grammar answer MD 1", GRAMMAR_HTML, SUCCESS, null, null, null, null, null, null),
                OPEN_AI, new Answer(OPEN_AI, "OpenAI prompt 1", "OpenAI answer MD 1", OPEN_AI_HTML, SUCCESS, null, null, null, null, null, null),
                CLAUDE, new Answer(CLAUDE, "Claude prompt 1", "Claude answer MD 1", CLAUDE_HTML, SUCCESS, null, null, null, null, null, null),
                GCP, new Answer(GCP, "GCP prompt 1", "GCP answer MD 1", GCP_HTML, SUCCESS, null, null, null, null, null, null)), null);
    }
    ...
    public static class I2 {
        ...
        public static final Interaction INTERACTION = new Interaction(new InteractionId(2L), InteractionType.QUESTION,
                THEME_ID, QUESTION, Map.of(
                GRAMMAR, new Answer(GRAMMAR, "QC prompt 2", "Grammar answer MD 2", I2.GRAMMAR_HTML, SUCCESS, null, null, null, null, null, null),
                OPEN_AI, new Answer(OPEN_AI, "OpenAI prompt 2", "OpenAI answer MD 2", I2.OPEN_AI_HTML, SUCCESS, null, null, null, null, null, null),
                CLAUDE, new Answer(CLAUDE, "Claude prompt 2", "Claude answer MD 2".repeat(CLAUDE_ANSWER_MULTIPLIER), I2.CLAUDE_HTML, FAIL, null, null, null, null, null, null),
                GCP, new Answer(GCP, "GCP prompt 2", "GCP answer MD 2", I2.GCP_HTML, SUCCESS, null, null, null, null, null, null)), null);
    }
    ...
    public static class I3 {
        ...
        public static final Interaction INTERACTION = new Interaction(new InteractionId(3L), InteractionType.QUESTION,
                THEME_ID, QUESTION, Map.of(
                GRAMMAR, new Answer(GRAMMAR, "QC prompt 3", "Grammar answer MD 3", I3.GRAMMAR_HTML, SUCCESS, null, null, null, null, null, null),
                OPEN_AI, new Answer(OPEN_AI, "OpenAI prompt 3", "OpenAI answer MD 3", I3.OPEN_AI_HTML, SUCCESS, null, null, null, null, null, null),
                CLAUDE, new Answer(CLAUDE, "Claude prompt 3", "Claude answer MD 3".repeat(CLAUDE_ANSWER_MULTIPLIER), I3.CLAUDE_HTML, FAIL, null, null, null, null, null, null),
                GCP, new Answer(GCP, "GCP prompt 3", "GCP answer MD 3", I3.GCP_HTML, SUCCESS, null, null, null, null, null, null)), null);
    }
