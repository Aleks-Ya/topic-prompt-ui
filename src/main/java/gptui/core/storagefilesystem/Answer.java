...
public record Answer(AnswerType answerType, String prompt,
                     ...
                     String modelId, String modelParams, Integer inputTokens, Integer outputTokens,
                     Integer totalTokens) {

    public Answer withPrompt(String prompt) {
        return new Answer(answerType, prompt, answerMd, answerHtml, answerState, responseId,
                modelId, modelParams, inputTokens, outputTokens, totalTokens);
    }
    ...
    public Answer withModelInfo(String modelId, String modelParams, Integer inputTokens, Integer outputTokens,
                                 Integer totalTokens) {
        return new Answer(answerType, prompt, answerMd, answerHtml, answerState, responseId,
                modelId, modelParams, inputTokens, outputTokens, totalTokens);
    }
