...
## Run from IDE
Run `topicpromptui.TopicPromptUiMain` class.
...
3. Build distribution and deploy to `/home/aleks/installed/TopicPromptUI`:
...
4. Add to `PATH` in `~/.bashrc`: `export PATH=$PATH:/home/aleks/installed/TopicPromptUI/bin`
5. Add a menu icon by `MenuLibre` application:
    1. Icon: `/home/aleks/installed/TopicPromptUI/bin/icon.png`
